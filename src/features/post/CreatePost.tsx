  ...
  return (
    <div style={{
      ...
      <motion.div
        ...
        <div className={`${isFullScreen ? 'px-3 sm:px-6 py-2 mb-[400px] lg:mb-0' : 'px-3 sm:px-4 py-2 sm:py-3'} border-b flex-shrink-0 ${theme === 'dark' ? 'border-gray-900' : 'border-gray-200/30'
          }`}>
                        ...
                        if (totalMedia === 1) {
                          ...
                          return (
                            <motion.div
                              ...
                              className={`relative group rounded-2xl sm:rounded-3xl overflow-hidden ${theme === 'dark'
                            ...
                            <div className="grid grid-cols-2 gap-2 sm:gap-3">
                              {allMedia.map((media, idx) => (
                                <motion.div
                                  ...
                                  className={`relative group rounded-2xl sm:rounded-3xl overflow-hidden backdrop-blur-xl ${theme === 'dark'
                                    ? 'bg-gray-900/30 border border-gray-900 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)]'
                                    : 'bg-white border border-gray-200/50 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)]'
                                    }`}
                                >
                          ...
                          return (
                            <div className="grid grid-cols-2 gap-2 sm:gap-3">
                              ...
                              <motion.div
                                ...
                                animate={{ opacity: 1, scale: 1 }}
                                transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1] }}
                                className={`row-span-2 relative group rounded-2xl sm:rounded-3xl overflow-hidden backdrop-blur-xl ${theme === 'dark'
                                  ? 'bg-gray-900/30 border border-gray-900 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)]'
                                  : 'bg-white border border-gray-200/50 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)]'
                                  }`}
                              >
                                    ...
                                    {eventKinds
                                      ...
                                      .map((kind) => (
                                        ...
                                        >
                                          ...
                                          {kind.desc && (
                                            <div className={`text-xs mt-0.5 ${eventKind === kind.value
                            ...
                            <div>
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  className={`w-full px-4 sm:px-5 pr-12 sm:pr-14 py-4 sm:py-4.5 text-base sm:text-lg rounded-xl sm:rounded-2xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 backdrop-blur-xl font-medium ${pollErrors['event-date'] || pollErrors['event-datetime']
                                    ? theme === 'dark'
                                      ? 'bg-gray-900/30 border-red-500/60 text-white focus:border-red-500 focus:ring-red-500/30'
                                      : 'bg-gray-50 border-red-500/60 text-gray-900 focus:border-red-500 focus:ring-red-500/30'
                                    : theme === 'dark'
                                ...
                                <div className="absolute right-4 sm:right-5 top-1/2 -translate-y-1/2 pointer-events-none">
                                  <Calendar className={`w-5 h-5 sm:w-6 sm:h-6 ${theme === 'dark' ? 'text-white/70' : 'text-gray-500'
                                    }`} />
                                </div>
                              </div>
                            ...
                            <div>
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  className={`w-full px-4 sm:px-5 pr-12 sm:pr-14 py-4 sm:py-4.5 text-base sm:text-lg rounded-xl sm:rounded-2xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 backdrop-blur-xl font-medium ${pollErrors['event-time'] || pollErrors['event-datetime']
                                    ? theme === 'dark'
                                      ? 'bg-gray-900/30 border-red-500/60 text-white focus:border-red-500 focus:ring-red-500/30'
                                      : 'bg-gray-50 border-red-500/60 text-gray-900 focus:border-red-500 focus:ring-red-500/30'
                                    : theme === 'dark'
                                ...
                                />
                                <div className="absolute right-4 sm:right-5 top-1/2 -translate-y-1/2 pointer-events-none">
                                  <Clock className={`w-5 h-5 sm:w-6 sm:h-6 ${theme === 'dark' ? 'text-white/70' : 'text-gray-500'
                                    }`} />
                                </div>
                              </div>
                          ...
                          <div className="space-y-4 sm:space-y-5">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full px-4 sm:px-5 py-4 sm:py-4.5 text-base sm:text-lg rounded-xl sm:rounded-2xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 backdrop-blur-xl font-medium ${theme === 'dark'
                            ...
                            <div>
                              ...
                              <motion.button
                                ...
                                className={`w-full px-4 sm:px-5 py-4 sm:py-4.5 text-base sm:text-lg rounded-xl sm:rounded-2xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 backdrop-blur-xl font-medium flex items-center justify-between ${eventIsOnline
                                  ? theme === 'dark'
                              ...
                              >
                                ...
                                <div className={`w-12 h-6 rounded-full transition-all duration-300 ${eventIsOnline
                                  ? theme === 'dark' ? 'bg-white' : 'bg-black'
                                  : theme === 'dark' ? 'bg-gray-600/60' : 'bg-gray-300'
                                  }`}>
                                  <motion.div
                                    className={`w-5 h-5 rounded-full mt-0.5 ${theme === 'dark' ? 'bg-white' : 'bg-white'
                                      }`}
                            ...
                            <div>
                              ...
                              <motion.button
                                ...
                                className={`w-full px-4 sm:px-5 py-4 sm:py-4.5 text-base sm:text-lg rounded-xl sm:rounded-2xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 backdrop-blur-xl font-medium flex items-center justify-between ${eventIsPaid
                                  ? theme === 'dark'
                                    ? 'bg-gray-900/50 border-gray-700 text-white'
                                    : 'bg-gray-100 border-gray-400 text-gray-900'
                                  : theme === 'dark'
                              ...
                              >
                                ...
                                <div className={`w-12 h-6 rounded-full transition-all duration-300 ${eventIsPaid
                                  ? theme === 'dark' ? 'bg-white' : 'bg-black'
                                  : theme === 'dark' ? 'bg-gray-600/60' : 'bg-gray-300'
                                  }`}>
                                  <motion.div
                  ...
                  {isLocationPickerOpen && (
                    ...
                    >
                      <div className={`rounded-xl border overflow-hidden ${theme === 'dark'
                        ...
                        {/* Compact Header */}
                        <div className={`flex items-center justify-between px-3 py-2 border-b ${theme === 'dark' ? 'border-gray-900' : 'border-gray-200'
                          }`}>
                          <div className="flex items-center gap-2">
                            <div className={`w-7 h-7 rounded-lg flex items-center justify-center ${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-100'
                              }`}>
                              <MapPin className={`w-3.5 h-3.5 ${theme === 'dark' ? 'text-white' : 'text-black'
                                }`} />
                            </div>
                        ...
                        <div className="p-3">
                          <motion.button
                            ...
                            className={`w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${isGettingLocation
                              ? theme === 'dark'
                          ...
                          >
                            {isGettingLocation ? (
                              <>
                                <div className={`w-3.5 h-3.5 border-2 border-t-transparent rounded-full animate-spin ${theme === 'dark' ? 'border-gray-900' : 'border-gray-400'
                                  }`} />
          ...
          {/* Compact Action Bar */}
          <div
            className={`flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 pt-2 ${parentPostId ? 'pb-3 sm:pb-2.5' : ''} border-t w-full max-w-full mt-auto flex-shrink-0 ${theme === 'dark' ? 'bg-gray-950 border-gray-900' : 'bg-white border-gray-200/30'
              }`}
          >
            ...
            <div className="flex flex-wrap items-center gap-1 sm:gap-1.5 flex-shrink-0">
              ...
              <motion.button
                ...
                className={`flex items-center justify-center w-10 h-10 sm:w-8 sm:h-8 rounded-lg transition-all duration-200 flex-shrink-0 ${selectedImages.some(f => f.type.startsWith('image/'))
                  ? theme === 'dark'
              ...
              <motion.button
                ...
                className={`flex items-center justify-center w-10 h-10 sm:w-8 sm:h-8 rounded-lg transition-all duration-200 flex-shrink-0 ${selectedVideos.length > 0
                  ? theme === 'dark'
              ...
              <motion.button
                onClick={addPoll}
                className={`flex items-center justify-center w-10 h-10 sm:w-8 sm:h-8 rounded-lg transition-all duration-200 flex-shrink-0 ${polls.length > 0
                  ? theme === 'dark'
              ...
              <motion.button
                ...
                className={`flex items-center justify-center w-10 h-10 sm:w-8 sm:h-8 rounded-lg transition-all duration-200 flex-shrink-0 ${isEmojiPickerOpen
                  ? theme === 'dark'
              ...
              <motion.button
                ...
                className={`flex items-center justify-center w-10 h-10 sm:w-8 sm:h-8 rounded-lg transition-all duration-200 flex-shrink-0 ${isStickerPickerOpen
                  ? theme === 'dark'
              ...
              <motion.button
                ...
                className={`flex items-center justify-center w-10 h-10 sm:w-8 sm:h-8 rounded-lg transition-all duration-200 flex-shrink-0 ${isGifPickerOpen
                  ? theme === 'dark'
              ...
              <motion.button
                ...
                className={`flex items-center justify-center w-10 h-10 sm:w-8 sm:h-8 rounded-lg transition-all duration-200 flex-shrink-0 ${isYouTubePickerOpen
                  ? theme === 'dark'
              ...
              <motion.button
                ...
                className={`flex items-center justify-center w-10 h-10 sm:w-8 sm:h-8 rounded-lg transition-all duration-200 flex-shrink-0 ${isEventActive
                  ? theme === 'dark'
                    ? 'bg-purple-500/15 text-purple-400'
                    : 'bg-purple-50 text-purple-600'
                  : theme === 'dark'
              ...
              <motion.button
                ...
                className={`flex items-center justify-center w-10 h-10 sm:w-8 sm:h-8 rounded-lg transition-all duration-200 flex-shrink-0 ${location || isLocationPickerOpen
                  ? theme === 'dark'
            ...
            <motion.button
              ...
              className={`w-full sm:w-auto sm:min-w-[120px] px-4 sm:px-5 py-3 sm:py-2 rounded-xl sm:rounded-lg font-semibold text-sm transition-all duration-200 flex-shrink-0 text-center ${hasEditorContent || selectedImages.length > 0 || selectedVideos.length > 0
                ? theme === 'dark'
            ...
            >
              {isSubmitting ? (
                <div className="flex items-center space-x-1 sm:space-x-1.5">
                  <div className={`w-2.5 h-2.5 sm:w-3 sm:h-3 border-2 border-t-transparent rounded-full animate-spin ${theme === 'dark' ? 'border-gray-900' : 'border-white'
                    }`} />
